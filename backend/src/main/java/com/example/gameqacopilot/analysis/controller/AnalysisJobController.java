...
import com.example.gameqacopilot.analysis.service.AnalysisPipelineService;
...
public class AnalysisJobController {
    ...
    public AnalysisJobController(AnalysisJobService analysisJobs, AnalysisPipelineService pipeline) {
    ...
    ApiResponse<AnalysisJobResponse> request(
        ...
        return ApiResponse.of(pipeline.run(documentId, user.id()));
    }
